...
public class MissileLauncher : MonoBehaviour
{
    ...
    private Transform missileLauncherHead;
    private Transform missileLauncherMuzzle;
    ...
    void Start()
    {
        ...
        missileLauncherHead = transform.GetChild(0);
        missileLauncherMuzzle = transform.GetChild(0).GetChild(0);
    ...
    void Fire()
    {
        ...
        {
            lastFireTime = Time.time;
            Bullet bullet1 = Instantiate(bulletPrefab, missileLauncherMuzzle.position, transform.rotation);
